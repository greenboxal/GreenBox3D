...
namespace Microsoft.VisualStudio.Project
{
    ...
    public class SolutionListenerForProjectReferenceUpdate : SolutionListener
    {
        ...
        public override int OnBeforeCloseProject(IVsHierarchy hierarchy, int removed)
        {
            if (removed != 0)
            {
                List<ProjectReferenceNode> projectReferences = GetProjectReferencesContainingThisProject(hierarchy);
        ...
        {
            List<ProjectReferenceNode> projectReferences = GetProjectReferencesContainingThisProject(realHierarchy);
            ...
            do
            {
                ...
                if (returnValue == VSConstants.S_OK && fetched == 1)
                {
                    ...
                    if (provider != null)
                    {
                        ...
                        ProjectReferenceNode projectReferenceNode =
