...
namespace Microsoft.VisualStudio.Project
{
    ...
    public sealed class ProjectElement
    {
        ...
        internal ProjectElement(ProjectNode project, string itemPath, string itemType)
        {
            ...
            item = project.BuildProject.AddItem(itemType, ProjectCollection.Escape(itemPath))[0];
        ...
        internal ProjectElement(ProjectNode project, ProjectItem existingItem, bool virtualFolder)
        {
            if (project == null)
                throw new ArgumentNullException("project");
        ...
        ///     Value to give to the attribute.  Use <c>null</c> to delete the metadata definition.
        /// </param>
            ...
            if (String.IsNullOrEmpty(attributeName) && exception != null)
            {
                if (String.IsNullOrEmpty(exception.Message))
                {
                    ...
                    string message = String.Format(CultureInfo.CurrentCulture,
                                                   SR.GetString(SR.AttributeLoad, CultureInfo.CurrentUICulture),
                                                   attributeName, itemProject.BaseURI.AbsoluteUrl);
        ...
        {
            string path = GetMetadata(ProjectFileConstants.Include);
