    ...
    public class FolderNode : HierarchyNode
    {
        ...
        public override int SetEditLabel(string label)
        {
            ...
            try
            {
                ...
                IVsUIShell shell = ProjectMgr.GetService(typeof(SVsUIShell)) as IVsUIShell;
            ...
            catch (Exception e)
            {
                throw new InvalidOperationException(String.Format(CultureInfo.CurrentCulture,
                                                                  SR.GetString(SR.RenameFolder,
                                                                               CultureInfo.CurrentUICulture), e.Message));
            }
            return VSConstants.S_OK;
        }
                                                            ...
                                                            IList<tagVsSccFilesFlags> flags)
        {
            ...
            FileNode node = FindChild(sccFile) as FileNode;
