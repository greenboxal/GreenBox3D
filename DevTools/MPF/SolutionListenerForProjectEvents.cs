...
namespace Microsoft.VisualStudio.Project
{
    ...
    internal class SolutionListenerForProjectEvents : SolutionListener, IProjectEvents
    {
        ...
        private void RaiseAfterProjectFileOpened(bool added)
        {
            ...
            EventHandler<AfterProjectFileOpenedEventArgs> tempEvent = AfterProjectFileOpened;
            if (tempEvent != null)
            {
        ...
        {
            // Save event in temporary variable to avoid race condition.
            EventHandler<BeforeProjectFileClosedEventArgs> tempEvent = BeforeProjectFileClosed;
            if (tempEvent != null)
            {
