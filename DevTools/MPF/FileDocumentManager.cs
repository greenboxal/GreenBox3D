...
namespace Microsoft.VisualStudio.Project
{
    ...
    public class FileDocumentManager : DocumentManager
    {
        ...
        public override int OpenWithSpecific(uint editorFlags, ref Guid editorType, string physicalView,
                                             ref Guid logicalView, IntPtr docDataExisting,
                        ...
                        WindowFrameShowAction windowFrameAction)
        {
            ...
            uint docCookie;
            string path = GetFullPathForDocument();
            ...
            try
            {
                ...
                if (openWith)
                {
                    result = uiShellOpenDocument.OpenStandardEditor((uint)__VSOSEFLAGS.OSE_UseOpenWithDialog, fullPath,
                                                                    ref logicalView, caption,
                                                                    Node.ProjectMgr.InteropSafeIVsUIHierarchy, Node.ID,
                ...
                else
                {
                    ...
                    if (editorType != Guid.Empty)
                    {
                        result = uiShellOpenDocument.OpenSpecificEditor(editorFlags, fullPath, ref editorType,
                                                                        physicalView, ref logicalView, caption,
                                                                        Node.ProjectMgr.InteropSafeIVsUIHierarchy,
                                                                        Node.ID, docDataExisting, serviceProvider,
                                                                        out windowFrame);
                    }
                    else
                    {
